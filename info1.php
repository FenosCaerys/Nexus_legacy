          ...
          <section id="services" class="services_area section_scroll ptb-110" data-scroll-index="2">
               <div class="container">
                    ...
                    <div class="row">
                         <div class="col-12">
                              <div class="section_title text-center">
                                   ...
                                   <h2 class="title"><span>Sony débarque dans le métaver </span></h2>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                         ...
                         <div class="col-lg-4">
                              <img src="img2/sony.jpg">
                         </div>

                         <p class="info_parag col-lg-8"> Un nouveau système de suivi de mouvements (motion-tracking) nommé mocopi qui est un dispositif minimaliste,
                              composé de petits capteurs à placer sur la tête, au niveau du bassin, ainsi qu'aux poignets et aux
                              chevilles, permettant de contrôler librement et en temps réel son avatar dans l'univers virtuel de Meta.
                              Il ne faut aucun doute que le grand géant mondie de l’électronique va axer sa stratégie marketing sur le
                              développement d’expériences métavers. Bien que cette opportunité ne soit pas si nouvelle que ça.
                              Fortuitement, SONY a confirmé prendre la question du métavers au sérieux a travers ses actions
                              d'investissement sur le projet Epic Games. Fortnite étant le jeu phare de cette société. L’entreprise
                              confirme donc après un conglomérat organisé récemment son choix pour le long terme.</p>
                    </div>

                    <p class="info_parag"> <br> <br> Partenaire prestigieux, projet solide : la multinationale prépare le terrain pour sortir le grand jeu.
                         Conscient de la force et de la puissance du métavers, le concepteur de Playstation confirme l’intérêt
                         de l’industrie du divertissement pour les réseaux sociaux de demain. Dans ce sens, Kenichiro Yoshida,
                         directeur général de la multinationale, déclare : « Le métavers est à la fois un espace social et un
                         espace de réseau en direct. Les jeux, la musique, les films, et les animations se croisent (…) Nous
                         pensons que ce sera un catalyseur pour améliorer nos capacités de jeu en direct (…) c’est une avancée
                         majeure pour devenir multiplateforme. »</p>
               </div>
          </section>
          ...
          <section id="blog" class="section_scroll blog_area ptb-110" data-scroll-index="5">
               <div class="container">
                    ...
                    <div class="row justify-content-center">
                         ...
                         <div class="col-lg-4 col-md-6">
                              <article class="entry_post text-center" style="height: 300px;">
                                   <h2 class="entry_title"> <a href="info2.php">Les camions électroniques de Tesla</a> </h2>
                                   <div class="entry_content">
