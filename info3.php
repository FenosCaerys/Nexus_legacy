          ...
          <section id="services" class="services_area section_scroll ptb-110" data-scroll-index="2">
               <div class="container">
                    ...
                    <div class="row">
                         <div class="col-12">
                              <div class="section_title text-center">
                                   ...
                                   <h2 class="title"><span>Le casque de réalité virtuel de iphone </span></h2>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                         ...
                         <div class="col-lg-4">
                              <img src="img2/V-R.jpg">
                         </div>

                         <p class="info_parag col-lg-8">Selon les sources le casque de réalité virtuelle de Iphone aura son propre système d’exploitation qui sera
                              baptisé xrOS. La firme de Cupertino travaille sur son casque depuis 2015 et pourrai prochainement la rendre
                              publique. L’appareil sera en outre équipé d’une technologie de balayage de l’iris permettant à son porteur
                              de payer avec ses yeux. La technologie franchira un nouvel cap bientôt. Énormément médiatisée a partir
                              des années 2010 jusqu'à nos jours, elle fait de nouveau parler d’elle depuis quelques mois. Si le projet
                              est nouveau à la mode grâce au réseau sociaux surtout Facebook et ses promesses de metaverse, elle pourrait,
                              en 2023, profiter de l’effet Apple.</p>

                    </div>

                    <p class="info_parag"> <br> <br> En effet, quand la plus célèbre des marques californiennes investit un marché, c’est généralement l’industrie
                              entière qui en profite dans tout les sens du terme. Suite une centaine de rumeurs, le projet nommé « Apple
                              Reality » qu'on avait à tord imagé sur une longue période comme être des lunettes connectées va sûrement
                              voir le jour prochainement. D’ici le second semestre 2023 selon les rumeurs (mais cette échéance pourrait
                              encore être décalée), Apple devrait présenter un casque haut de gamme dédié à la réalité virtuelle et à la
                              réalité augmentée. Pour vous aider à y voir plus clair, nous vous proposons cet article explicatif.</p>
               </div>
          </section>
