            ...
            <div class="container">
                 ...
                 <div class="row">
                      <div class="col-12">
                           <div class="section_title text-center">
                                ...
                                <h2 class="title"><span>Paiements par carte de crédit : Souriez, vous avez été débité !</span></h2>
                           </div>
                      </div>
                 </div>
                 ...
                 <div class="row justify-content-center">
                    ...
                    <p> Des spécialistes des systèmes bancaires et de paiement et de retrait tels que Visa et
                        Mastercard étudient la possibilité de payer par reconnaissance faciale. Mastercard a annoncé dans un communiqué de presse
                        établir un ensemble de normes de conformité pour les banques, les commerçants et les prestataires de services
                        techniques permettant de s'assurer que les données privées des consommateurs utilisant ce service sont correctes et
                        garantie.Le rival de Visa vise à permettre la vérification des paiements avec le sourire devant un écran ou
                        Faites simplement signe aux lecteurs ci-dessus ! Ce processus de paiement biométrique unique a été testé.</p> 
                    
                        <p> Quelle est la protection des données biométriques ?
                        "Pour les commerçants, les avantages sont également importants, notamment des délais de transaction plus rapides et
                        Des files d'attente plus courtes à plus d'hygiène et à une sécurité améliorée, Mastercard s'est justifié. système
                        Les méthodes de paiement peuvent être combinées avec des programmes de fidélité et des recommandations personnalisées pour aider les clients
                        Les consommateurs peuvent trouver des produits susceptibles de les intéresser en fonction de leurs achats précédents. »</p> 
                    
                        <p> Alors même que le géant américain met l'accent sur la sécurité des données et la simplicité du système, ça va se compliquer.
                        Actuellement,
                        lorsque vous vérifiez le paiement avec votre smartphone à l'aide de votre empreinte digitale, l'image est stockée dans l'appareil,
                        pas sur le site Web du commerçant ou sur le serveur de la banque.
                    
                        L'Europe interdit la reconnaissance faciale dans les lieux publics.
                        La reconnaissance faciale enregistre les caractéristiques corporelles d'une personne qui ne peuvent pas être modifiées
                         De plus, « un grand nombre d'images ont été
                        Disponible (par exemple sur Internet) et possibilité de prendre des images faciales à distance à votre insu
                        peur de l'usurpation d'identité.
                    
                        Les utilisateurs du métro de Moscou enregistrent leurs photos une fois pour toutes dans l'application
                        et leurs coordonnées bancaires. Les caméras de la station de métro se chargent alors de facturer leur abonnement
                        Selon leur passage dans le tourniquet. puisque
                        La reconnaissance faciale est interdite dans les lieux publics.</p>
               ...
               <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6" >
                         <article class="entry_post text-center" style="height: 300px;">
                              <h2 class="entry_title"> <a href="info3.html" target="BLANK">Cette lentille de contact affiche des notifications sur l'œil</a> </h2>
                              <div class="entry_content">
                                   <p>InWith annonce les premières lentilles de contact souples capables d'afficher des
                                         informations directement sur l'œil. Elles peuvent également corriger la vue.</p>
                              </div>
