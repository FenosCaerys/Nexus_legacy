          ...
          <section id="services" class="services_area section_scroll ptb-110" data-scroll-index="2">
            <div class="container">
                 ...
                 <div class="row">
                      <div class="col-12">
                           <div class="section_title text-center">
                                ...
                                <h2 class="title"><span>Des lunettes de réalité augmentée pour les médecins</span></h2>
                           </div>
                      </div>
                 </div>
                 ...
                 <div class="row justify-content-center">
                    ...
                    <p> Les médecins de combat sont essentiels au sein de l’armée. Ils sont les premiers à intervenir sur le terrain pour
                        sauver la vie des militaires blessés. Ils doivent agir rapidement pour augmenter les chances de survie de leurs
                        patients. Malgré une formation poussée, ils n'ont pas l'expérience des médecins spécialistes et n'ont souvent pas le
                        temps de chercher des informations sur une procédure urgente.
                        La Darpa, l'agence de recherche militaire américaine, compte leur venir en aide grâce à des lunettes de réalité
                        augmentée. Baptisées Magic (Medical Assistance, Guidance, Instruction and Correction), elles sont développées par
                        l'entreprise Raytheon Technologies.</p>
                    
                       <p> Une assistance basée sur l’Intelligence artificielle
                        Le système Magic intègrera une base de données concernant 50 procédures différentes, avec 2.500 vidéos
                        stéréoscopiques et près de 50 millions d'images. Les lunettes intègreront également deux caméras associées à une
                        intelligence artificielle, capable d'analyser les actions du médecin et de vérifier qu'il suit correctement les
                        étapes. L'IA fournira aussi des informations cruciales comme le temps écoulé ou le dosage recommandé.</p>
                    
                       <p> Les lunettes pourront être commandées vocalement et offriront une assistance automatique grâce à l'IA. Le médecin
                        pourra choisir entre l'affichage des informations ou un guidage vocal pour éviter d'encombrer son champ visuel. Le
                        système Magic ne sera toutefois pas disponible sur le terrain avant quelques années. Raytheon Technologies compte
                        effectuer sa première démonstration de ses lunettes dans 18 mois...</p>
